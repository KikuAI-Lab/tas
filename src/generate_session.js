...
var API_ID = parseInt(process.env.API_ID, 10);
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    client = new telegram_1.TelegramClient(new sessions_1.StringSession(''), API_ID, API_HASH, {
                        connectionRetries: 5,
                        useWSS: true
                    });
                    return [4 /*yield*/, client.start({
                            phoneNumber: function () { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, input_1.default.text('Please enter your phone number: ')];
                                        case 1:
                                            phone = _a.sent();
